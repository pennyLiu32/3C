...
MAX_ITEMS = 20
OUTPUT_FILE = "tk3c_fridge_top20.csv"
CATEGORY = "冰箱"
SEARCH_KEYWORD = "冰箱"

EXCLUDE_KEYWORDS = ["除臭劑", "保鮮盒", "密封袋", "分隔盒", "冰箱貼", "整理盒", "收納盒", "製冰盒", "除霜", "溫度計", "保鮮膜", "清潔劑", "濾網", "保冷劑"]

REQUIRE_SIZE_IN_NAME = True
SIZE_PATTERN = re.compile(r"\d+\s*(公升|L)", re.IGNORECASE)
...
def run_fridge_crawler():
    """執行冰箱爬蟲，回傳整理好的商品資料 list"""
